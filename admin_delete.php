...
<head>
	...
	<style>
	body{
		background-image: url(../css/mainback.jpg);
...
if(!$conn){
	...
	if($productCount>0){
	 ...
	 while($row=mysql_fetch_array($result)){
	 	...
	 	<tr>
	 	<td width='28%' valign='top'><img style='border:#fff 20px solid;' src='images/".$pcode.".jpg' alt=".$pname." width='150' height='220' border='1'></td>
	 	<td width='72%' align='top' style='padding:20px'>
	 	<h4>Product Code: ".$pcode."</h4>
	 	<h3>Product Name: ".$pname."</h3>
	 	<h2>Price:Rs.".$price."/-</h2>
	 	<h4>Quantity: ".$quantity."</h2>
	 	<h4>Type: ".$type."</h4>
	 	<h4>Brand: ".$brand."</h4>
